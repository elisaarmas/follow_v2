...
add_action( 'tgmpa_register', 'follow_register_required_plugins' );
 ...
 */
function follow_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/plugins/soil.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '3.7.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
	 ...
	 */
	$config = array(
		'id'           => 'follow-plugins',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'follow-install-plugins', // Menu slug.
